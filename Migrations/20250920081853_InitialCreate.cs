    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Construction equipment and tools", "Construction" },
                    { 2, "Audio and visual equipment", "Audio/Visual" },
                    { 3, "Equipment for parties and events", "Party & Events" },
                    { 4, "Various tools for different purposes", "Tools" }
                });
